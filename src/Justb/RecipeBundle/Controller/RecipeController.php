...
use Justb\RecipeBundle\Entity\Recipe;
use Justb\RecipeBundle\Form\RecipeType;
...
class RecipeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JustbRecipeBundle:Recipe')->findAll();
     ...
     * @Method("POST")
     * @Template("JustbRecipeBundle:Recipe:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JustbRecipeBundle:Recipe')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("JustbRecipeBundle:Recipe:edit.html.twig")
     */
